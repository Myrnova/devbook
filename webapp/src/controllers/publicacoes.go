...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	response, erro := requisicoes.FazerRequisicaoComAutenticacao(r, http.MethodPost,
...
//CurtirPublicacao chama a API para curtir uma publicacao no banco de dados
...
//DescurtirPublicacao chama a API para descurtir uma publicacao no banco de dados
...
//AtualizarPublicacao chama a API para atualizar uma publicacao no banco de dados
...
//DeletarPublicacao chama a API para deletar uma publicacao no banco de dados
