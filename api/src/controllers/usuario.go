...
//PararDeSeguirUsuario permite que um usuário pare de siga outro
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = security.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("a senha atual passada não é a correta"))
		return
	}
