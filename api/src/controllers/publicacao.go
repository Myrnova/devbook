...
func BuscarPublicacoes(w http.ResponseWriter, r *http.Request) {
	...
	publicacoes, erro := repositorio.BuscarPublicacoes(usuarioIDNoToken)
...
//BuscarPublicacao tras uma única publicação
...
//AtualizarPublicacao atualiza a publicacao do usuario
...
//DeletarPublicacao deleta os dados de uma publicacao
